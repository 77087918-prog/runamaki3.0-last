                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-center gap-3 mt-4 pt-4 border-t border-gray-200">
                                ...
                                <form action="{{ route('admin.habilidades.eliminar', $habilidad->id) }}" method="POST" class="inline ml-auto" 
                                      onsubmit="return confirm('¿Estás seguro de eliminar esta habilidad? Esta acción no se puede deshacer.')">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn bg-gray-600 hover:bg-gray-700 text-white text-sm">
                                        <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
